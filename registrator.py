...
def _set_default_admin_class_for_model_subclasses(model_class: type[Model], admin_class: type[ModelAdmin]):
	...
	_logger.debug(
		f"admin class {Style.BRIGHT}{Fore.GREEN}{admin_class.__qualname__}{Style.RESET_ALL} succesfully setted "
		f"as default admin class for subclasses of {Style.BRIGHT}{Fore.GREEN}{typename(model_class)}{Style.RESET_ALL}."
	)
